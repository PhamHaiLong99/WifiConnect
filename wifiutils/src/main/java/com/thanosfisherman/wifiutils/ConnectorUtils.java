...
//                (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    static boolean connectToWifi(@NonNull final Context context, @Nullable final WifiManager wifiManager, @Nullable final ConnectivityManager connectivityManager, @NonNull WeakHandler handler, @NonNull final ScanResult scanResult, @NonNull final String password, @NonNull WifiConnectionCallback wifiConnectionCallback, boolean patternMatch, @Nullable String ssid) {
        ...
        if (isAndroidQOrLater()) {
            return connectAndroidQ(context,wifiManager, connectivityManager, handler, wifiConnectionCallback, scanResult, password, patternMatch, ssid);
        }
...
//
    ...
    public static void forgetNetwork(Context context, WifiManager wifiManager){
        Integer id = wifiManager.getConnectionInfo().getNetworkId();
        wifiLog("getNetworkId in forgetNetwork"+ String.valueOf(id));
        wifiManager.removeNetwork(wifiManager.getConnectionInfo().getNetworkId());
        wifiManager.saveConfiguration();
    }
    public static void connectToNetwork(String ssid, String password,Context context, WifiManager wifiManager,@NonNull ScanResult scanResult ) {
        WifiConfiguration wifiConfiguration = new WifiConfiguration();
        wifiConfiguration.SSID = "\"" + ssid + "\"";
        wifiLog("Connect Network");
