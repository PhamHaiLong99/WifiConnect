...
public class DisconnectCallbackHolder {
    ...
    @Nullable
    private List<WifiNetworkSuggestion> mNetworkSuggestionsList;
    private boolean isNetworkcallbackAdded;

    private boolean isNetworkSuggestionsAdded;
    ...
    public void addNetworkSuggestions(@NonNull List<WifiNetworkSuggestion> suggestionsList){
        mNetworkSuggestionsList = suggestionsList;
        isNetworkSuggestionsAdded = true;
    }
    /**
    ...
    public void disconnectSuggestion () {
